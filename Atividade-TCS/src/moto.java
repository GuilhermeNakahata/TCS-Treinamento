...
public class moto extends veiculo {
	...
	public moto(int consumoKm, int ano, int kmRodados, String placa, String cor, double capacidadeTanque,
			double quantidadeTanque, double kmPneus, double velocidadeMaxima) {
		super(consumoKm, 2, ano, kmRodados, placa, cor, capacidadeTanque, quantidadeTanque, kmPneus,
				velocidadeMaxima);
	}
	...
	public void Ligar() {
		if (isStatus()) {
			System.out.println("Moto ja esta ligado!");
		} else {
			setStatus(true);
	...
	public void Desligar() {
		if (isStatus()) {
			...
			System.out.println("Moto ja esta desligado!");
		}
	...
	public void Abastecer() {
		if (getVelocidade() == 0) {
			if (isStatus()) {
				setStatus(false);
				System.out.println("Moto foi desligado para Abastecer!");
			}
			...
			System.out.println("Moto Abastecido, o total a pagar foi: "
					+ ((getCapacidadeTanque() - capacidadeAnterior) * precoGasolina));
		} else {
			System.out.println("Nao eh possivel abastecer com a moto andando");
		}
	}
	...
	public void Abastecer(int Quantidade) {
		if (getVelocidade() == 0) {
			...
			if (Quantidade < getQuantidadeTanque()) {
				...
				System.out.println("Moto Abastecido, o total a pagar foi: " + Quantidade * precoGasolina);
			} else {
				System.out.println("Nao eh possivel colocar essa quantidade no tanque!");
			}
		} else {
			System.out.println("Nao eh possivel abastecer com o moto andando");
		}
	}
	...
	public void TrocarPneu() {
		if (isStatus()) {
			setStatus(false);
			System.out.println("Moto desligado para trocar pneu!");
		}
